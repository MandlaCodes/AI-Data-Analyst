        ...
        <div className="text-slate-200 px-6 md:px-12 pb-12 font-sans selection:bg-purple-500/30">
            {(isInitializing || isImporting) && (
                <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#020617]/95 backdrop-blur-xl">
                    ...
                    <p className="text-sm font-black tracking-[0.4em] text-white uppercase animate-pulse">Neural Ops Initializing...</p>
                </div>
            )}
            ...
            <div className="max-w-[1600px] mx-auto space-y-10">
                <div className="pt-8">
                    <WorkbenchHeader 
                        ...
                        onSave={handleSave} 
                        onOpenAI={() => setIsAnalysisPanelOpen(true)} 
                    />
                </div>
                ...
                {allDatasets.length > 0 ? (
                    <>
                        <div className="flex items-center gap-4 px-2">
                            <h3 className="text-xs font-black text-slate-500 uppercase tracking-[0.3em]">Neural Streams</h3>
                    ...
                    <div className="text-center py-32 bg-white/[0.01] rounded-[3rem] border border-white/5">
                        ...
                        <p className="text-slate-500 text-sm mt-2 max-w-xs mx-auto">Initialize your neural workspace by importing a data stream.</p>
            ...
            <AIAnalysisPanel isOpen={isAnalysisPanelOpen} onClose={() => setIsAnalysisPanelOpen(false)} datasets={activeDatasets} />
        </div>
    );
}