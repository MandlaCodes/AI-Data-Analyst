...
      // --- Success ---
      // 1. Save token and profile to Local Storage
...
      case 'info':
        return <FiLoader style={{ marginRight: 8 }} className="animate-spin" />;
      default:
        return null;
    }
  };
...
            <FiTerminal style={{ color: '#a78bfa', marginRight: 8, fontSize: 32 }} />
